...
<template>
  <div class="default-layout pl-[240px] h-screen">
    <div class="flex flex-col h-full">
      <header
        class="min-h-10 bg-gray-200 text-gray-900 sticky top-0"
    ...
    <Menu :model="items" class="w-full md:w-60 fixed top-0 left-0 h-full">
      <template #start>
